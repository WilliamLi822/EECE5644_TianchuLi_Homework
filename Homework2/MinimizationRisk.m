function c = MinimizationRisk(mu1,Sigma1,mu2,Sigma2,N,n,p1)
...
if ind10==0
legend('L = 1, decision = 1','L = 2, decision = 1','L = 2, decision = 2','Location','NorthWest'); 
elseif ind01==0
legend('L = 1, decision = 1','L = 1, decision = 2','L = 2, decision = 2','Location','NorthWest'); 
else
legend('L = 1, decision = 1','L = 1, decision = 2','L = 2, decision = 1','L = 2, decision = 2','Location','NorthWest'); 
end
